        ...
        case "log:subscribe": // Someone joined the gc
          ...
          for (let newParticipant of addedParticipants1) {
            ...
            if (newParticipant.userFbId == botID1) {
              message1.body = `Hi, I am EagleBot. Thank you for having me as the ${toOrdinalNumber(participants1.length)} member of "${threadName1}".\n\n`;
              ...
              message1.mentions.push({
                tag: "@Danilo Manto", id: "100085642972736"
              });

              // Set bot's nickname
              api.changeNickname("EagleBot", event.threadID, botID1, (err) => {
